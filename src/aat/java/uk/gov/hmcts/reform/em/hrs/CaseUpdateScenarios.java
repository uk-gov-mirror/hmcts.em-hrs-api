...
public class CaseUpdateScenarios extends BaseTest {
    ...
    private static final String FOLDER = "audiostream102";
    private static final String RECORDING_REF = "audiostream102/FM-0111-testfile200M_2020-01-01-11.11.11.123-UTC_0.mp4";
