...
public class AuditEntryService {
    ...
    <DateTime> <Tag> Operation:<Operation Type> , Case_Id:<Case Id>[,<case Id>]..., IDAM_Id:<IDAM ID>, Invoking_service:<Invoking Service>, Endpoint_called:<Endpoint Called>, Operational_outcome:<Operational Outcome>[, Case_type:<Case Type>][, Jurisdiction:<Jurisdiction>][, Event_selected:<Event Selected>][, IDAM_Id_of_target:<IDAM ID Of Target>] [,List_of_case_types:<List Of Case Types>][,Target_case_roles:<Target Case Roles>][, X-Correlation-ID:<x-correlation-id>]

    https://tools.hmcts.net/confluence/display/RCCD/CCD+Case+Log+And+Audit+Design - note that the page contains two variants of
    field naming - ie eventCategory + eventStatus vs operationType

   https://github.com/hmcts/ccd-data-store-api/tree/fe854a98ef57dfb2d63a05800de90a7618459f50/src/main/java/uk/gov/hmcts/ccd/auditlog
