...
public class V1MimeTypes extends MediaType implements Serializable {
    ...
    public static final String APPLICATION_DOCX_VALUE = "application/msword"; //"application/vnd.openxmlformats-officedocument.wordprocessingml.document";
    ...
    public static final String APPLICATION_PPT_VALUE = "application/vnd.ms-powerpoint";
